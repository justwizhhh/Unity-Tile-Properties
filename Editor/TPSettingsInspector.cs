        ...
        private void OnEnable()
        {
            ...
            settings_entries.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
            {
                ...
                GUI.DrawTexture(
                    ...
                    (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Third-Party/justWiz/TileProperties/Editor/Icons/TilePropertiesList Icon.png", typeof(Texture2D)),
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (enable_button_icon == null)
            {
                enable_button_icon = (Texture2D)AssetDatabase.LoadAssetAtPath(
                    "Assets/Third-Party/justWiz/TileProperties/Editor/Icons/TilePropertyEnablePreview Icon.png", typeof(Texture2D));
            }
            ...
            if (disable_button_icon == null)
            {
                disable_button_icon = (Texture2D)AssetDatabase.LoadAssetAtPath(
                    "Assets/Third-Party/justWiz/TileProperties/Editor/Icons/TilePropertyDisablePreview Icon.png", typeof(Texture2D));
            }
        ...
        static void AssignSOIcon()
        {
            if (!icon_assigned)
            {
                var settings_icon = AssetDatabase.LoadAssetAtPath<Texture2D>(
                    "Assets/Third-Party/justWiz/TileProperties/Editor/Icons/TilePropertySettings Icon.png");
